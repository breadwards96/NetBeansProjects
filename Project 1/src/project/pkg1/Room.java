 ...
 * do not add your name, date, and honor code to it. */
 ...
 /* 
  * The Room class is a superclass that holds information about a room in the game. 
  *
  * The field roomNum is the ID of the room, and roomName is the name of the room. 
  * The field roomObjects is of type String, 
  * and holds a string representation of the items that are in the room, 
  * separated by a semicolon. 
  * The field roomExits, of type String, contains information 
  * about which of the cardinal points in the room (n for north, 
  * s for south, e for east, and w for west) lead to which other rooms in the game. 
  * If a room has more than one exit, 
  * the exits in the roomExits string are separated by semicolons. 
  */
